...
exports.signIn = catchAsync(async (req, res, next) => {
  ...
  if (!username || !password) {
    return next(new AppError("Please provide password and username", 400));
  }
...
exports.restrictTo = (...roles) => {
  return (req, res, next) => {
    if (!roles.includes(req.user.role)) {
      ...
      return next(
        new AppError("You don't have the permission to do this!", 403)
      );
    }
    next();
  };
...
exports.forgetPassword = catchAsync(async (req, res, next) => {
  ...
  We hope this email finds you well. It appears that you have requested a password reset for your account on Toro Store. To proceed with resetting your password, please follow the instructions below:
  Click on the following link to access the password reset page: ${url}
  Please note that this link is valid for the next 10 minutes. After this period, you will need to request another password reset.
